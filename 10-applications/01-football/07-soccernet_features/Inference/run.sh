...
# python3.7 -B -m paddle.distributed.launch --gpus="4,5,6,7" --log_dir=log_movinet main.py --validate -c configs/recognition/movinet/movinet_ucf101_frame.yaml
# python3.7 -B -m paddle.distributed.launch --gpus="0" --log_dir=log_pptsm_MRI  main.py  --validate -c applications/PP-Care/configs/pptsm_MRI.yaml
# python3.7 -B -m paddle.distributed.launch --gpus="0" --log_dir=log_pptsn_MRI main.py  --test -c applications/PP-Care/configs/pptsm_MRI.yaml -w "/home/zhangyuxuan07/PaddleSports/PaddleVideo-develop/output/ppTSM_MRI/0727/ppTSM_MRI_best.pdparams"

# python3.7 -B -m paddle.distributed.launch --gpus="0,1,2,3,4,5,6,7" --log_dir=log_videoswin  main.py  --validate -c configs/recognition/videoswin/videoswin_k400_videos_soccer.yaml

# python3.7 tools/export_model.py -c configs/recognition/videoswin/videoswin_k400_videos_soccer.yaml \
#                                 -p output/VideoSwin/VideoSwin_epoch_00030.pdparams \
#                                 -o inference/VideoSwin

# python3.7 tools/predict.py --input_file /home/zhangyuxuan07/PaddleSports/SoccerData/output/video_clips \
#                            --config configs/recognition/videoswin/videoswin_k400_videos_soccer.yaml \
#                            --model_file inference/VideoSwin/VideoSwin.pdmodel \
#                            --params_file inference/VideoSwin/VideoSwin.pdiparams \
#                            --use_gpu=True \
#                            --use_tensorrt=False

# python3.7 -B -m paddle.distributed.launch --gpus="1" --log_dir=log_videoswin  main.py  --test -c data/soccernet_inference/pptimesformer_soccer_extract_feature.yaml -w # add trained pdparams path

# python3.7 -B -m paddle.distributed.launch --gpus="0" --log_dir=log_soccernet_feature_test  main.py  --test -c data/soccernet_inference/pptimesformer_soccer_extract_feature.yaml -w output/ppTimeSformer/ppTimeSformer_epoch_00020.pdparams

# python3.7 -B -m paddle.distributed.launch --gpus="0" --log_dir=log_soccernet_feature_test  main.py  --test -c data/soccernet_inference/pptimesformer_soccer_extract_feature.yaml -w pretrained_weights/ppTimeSformer_k400_8f_distill.pdparams


python3.7 -B -m paddle.distributed.launch --gpus="0" --log_dir=log_soccernet_feature_test  main.py  --test -c data/soccernet_inference/soccernet_videoswin_k400_extract_features.yaml -w pretrained_weights/swin_base_patch4_window7_224.pdparams


# python3.7 -B -m paddle.distributed.launch --gpus="2" --log_dir=log_pptsn_soccer  main.py  --validate -c configs/recognition/pptsn/pptsn_k400_videos_soccer.yaml
